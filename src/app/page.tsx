...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 pointer-events-none bg-gradient-to-br from-amber-950/20 via-black to-amber-900/20"></div>
      ...
      />
      <motion.div 
        className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-amber-600/10 rounded-full blur-3xl pointer-events-none"
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-6 py-12">
        ...
        >
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            ...
            >
              <div className="absolute inset-0 pointer-events-none bg-gradient-to-r from-amber-400 via-amber-300 to-amber-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
